...
* If user ask particularly that download vir defects for Lady Amanda and upload in Shippalm. Do following sequentially Step 1. Execute vir.py file in autowork folder Step 2. Open the downloaded excel file Step 3. Execute shippalm.py file in autowork folder and then stop.
</IMPORTANT>"""
